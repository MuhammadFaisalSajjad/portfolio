    ...
    <React.Fragment>
      {profile.map((response) => (
        <Card
          ...
          key={response._id}
        >
          <Card.Section className="p-[4vw] pb-1">
            <Image
              src={response.avatar}
              alt={response.name}
              height={100}
          ...
          <Card.Section className={classes.section} mt="md">
            <Group justify="apart">
              <Text fz="h2" fw={700} className="mx-auto">
                {response.name}
              </Text>
            </Group>
            ...
            <ul className={classes.sIcons}>
              <li className={classes.iconContent}>
                <a
                  data-social="linkedin"
                  aria-label="LinkedIn"
                  href="https://www.linkedin.com/in/muhammad-faisal-sajjad?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                  rel="noopener"
                >
              ...
              <li className={classes.iconContent}>
                <a
                  data-social="github"
                  aria-label="GitHub"
                  href="https://github.com/MuhammadFaisalSajjad"
                  target="_blank"
                  rel="noopener"
                >
                  <div className={classes.filled}></div>
              ...
              <li className={classes.iconContent}>
                <a
                  ...
                  href="https://www.instagram.com/mfaisal_530?igsh=MWtsb296amQwejVtYw=="
                  target="_blank"
                  rel="noopener"
                >
                  <div className={classes.filled}></div>
